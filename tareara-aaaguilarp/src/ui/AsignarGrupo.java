 ...
 * @author HP
 */
class AsignarGrupo implements IMenu{
    ...
    public void agregar(String dni){
        ...
        else Almacen.Agregar("Profesores", dni, "Grupos asignados\n"+Controles.Imprimir(DNI));
    }
    @Override
        ...
        while (9!=8) {
            ...
            switch (i) {
                case 1 -> {
                    ...
                    dni=sc.next();
                    if(!"Error".equals(Controles.Existe("Grupos", dni)))DNI.add(dni);
                ...
                case 4 -> Controles.VerTodo("Grupos");
                case 5 -> {
                    break OUTER;
                }
